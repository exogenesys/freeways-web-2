...
class Index extends React.Component {
		...
		this.state = {
			...
			altitude: [
			...
			], difficulty: [
				{
					title: 'any',
					level: [0, 1, 2, 3, 4],
					icon: 'data:image/png;base64,',
					color: 'red'
				},
				{
					title: 'easy',
	...
	static async getInitialProps() {
		const res = await axios.get('http://localhost:3000/api/treks/');
		const data = res.data;
		return { data };
	}
	...
	componentDidUpdate() {
		if (this.state.needsUpdate) {
			...
			if (this.state.activeRegion) {
				updatedList = this.region(updatedList, this.state.activeRegion)
			}
			updatedList = this.altitude(updatedList, this.state.altitude[this.state.activeAltitudes].upper, this.state.altitude[this.state.activeAltitudes].lower)

			updatedList = this.difficulty(updatedList, this.state.difficulty[this.state.activeDifficulty].level)
	...
	altitude(list, u, l) {
		return list.filter(function (place) {
			return place.max_altitude <= u && place.max_altitude >= l
		});
	}
	...
	difficulty(list, d) {
		console.log(d)
		return list.filter(function (place) {
			return d.indexOf(place.difficulty) != -1
		});
	}
	...
	handleAltitudeClick = (e, { altIndex }) => {
		if (this.state.activeAltitudes === altIndex) {
			altIndex = 0
		}
		this.setState({ activeAltitudes: altIndex, isLoading: true, needsUpdate: true, items: [] })
	}

	handleDifficultyClick = (e, { altIndex }) => {
		if (this.state.activeDifficulty === altIndex) {
			altIndex = 0
		}
		this.setState({ activeDifficulty: altIndex, isLoading: true, needsUpdate: true, items: [] })
	}
	...
	handleRegionChange = (e, { name }) => {
		this.setState({ activeRegion: name, isLoading: true, needsUpdate: true, items: [] })
	}
	...
	render() {
		...
		const regions = [
			'All', 'Himachal Pradesh', 'Uttarakhand'
		];
		...
		let altitudeItems = this.state.altitude.map((item, i) => {
			let limit = null
			if (item.upper)
				limit = <Label color='blue'>{item.lower} - {item.upper}</Label>
			return (
				<Menu.Item style={{
					color: 'rgba(0,0,0,.87)',
					textTransform: 'capitalize'
				}} className='InterestItem' color={item.color} name={item.title} altIndex={i} active={this.state.activeAltitudes == i} onClick={this.handleAltitudeClick}>
					<Icon style={{
						marginBottom: '10px'
					}} size='large'><Image src={item.icon} /></Icon>
					{item.title}{limit}
		...
		let difficultyItems = this.state.difficulty.map((item, i) => {
			return (
				<Menu.Item style={{
					color: 'rgba(0,0,0,.87)',
					textTransform: 'capitalize'
				}} className='InterestItem' color={item.color} name={item.title} altIndex={i} active={this.state.activeAltitudes == i} onClick={this.handleDifficultyClick}>
					<Icon style={{
						marginBottom: '10px'
					}} size='large'><Image src={item.icon} /></Icon>
					{item.title}
		...
		let regionItems = regions.map((item) => {
			return (
				<Dropdown.Item name={item} onClick={this.handleRegionChange}>
					{item}
				</Dropdown.Item>
			);
		});
		...
		return (
			...
			<Layout>
				<TopBar handleDimmer={e => this.handleDimmer(e)} root={false} page='treks' />
								...
								<Sticky innerZ={99999999999} bottomBoundary={'#Sidebar'}>
									<Segment basic>
										<Menu style={SideBarMenuStyle} vertical fluid text secondary>
											<Header style={{
											}} size='medium'>Difficulty</Header>
											{difficultyItems}
										</Menu>
										<Menu style={SideBarMenuStyle} vertical fluid text secondary>
											<Header style={{
											}} size='medium'>Altitude</Header>
											{altitudeItems}
										</Menu>
									</Segment>
								</Sticky>
													...
													<div ref='places'>
														...
														<Menu style={{
															...
															<Menu.Menu position='right'>
																...
																<Dropdown item text={this.state.activeRegion} floating labeled className='ClearFilterItemStyle'>
																	<Dropdown.Menu style={{
																		zIndex: 53
																	}}>
																		{regionItems}
