...
const items = [
		...
		<Brick type={items[0].type} data={items[0].data}/></Grid.Column>
		<Grid.Column computer={11} tablet={8} mobile={16}>
		<Brick type={items[1].type} data={items[1].data}/></Grid.Column>
		</Grid.Row>
		<Grid.Row>
		<Grid.Column computer={5} tablet={8} mobile={16}>
		<Brick type={items[5].type} data={items[5].data}/></Grid.Column>
		<Grid.Column computer={6} tablet={8} mobile={16}>
		<Brick type={items[3].type} data={items[3].data}/></Grid.Column>
		<Grid.Column computer={5} tablet={8} mobile={16}>
		<Brick type={items[4].type} data={items[4].data}/></Grid.Column>
		</Grid.Row>
		<Grid.Row>
		<Grid.Column computer={11} tablet={8} mobile={16}>
		<Brick type={items[2].type} data={items[2].data}/></Grid.Column>
		<Grid.Column computer={5} tablet={8} mobile={16}>
		<Brick type={items[0].type} data={items[6].data}/></Grid.Column>
		</Grid.Row>
		</Grid>
		</Segment>
		)
